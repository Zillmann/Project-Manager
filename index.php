...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="_/css/myOverrides.css">
    <link rel="icon" type="icon" href="_/img/favicon.ico">
  </head>
  ...
  <body id="mainpage">
    ...
    <script type="text/javascript" src="_/js/myScripts.js"></script>
  </body>
</html>